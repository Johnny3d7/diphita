<div class="modal fade" id="versementModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <form action="{{ route('admin.versement.store') }}" method="post" class="versement_form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <input type="text" class="id_souscripteur" value="{{ $souscripteur->id }}" name="id_adherent" hidden required>
                    ...
                    {{-- <div class="form-group">
                        <button type="submit" id="verser" class="verser btn btn-primary">Enregistrer</button>
                    </div> --}}
                </div>
            </form>
        </div>
