                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <div class="common_date_picker">
                                            <input class="datepicker-here digits this-bc @error('date_naiss') is-invalid @enderror" type="text" data-language="en" placeholder="Date de naissance *" name="date_naiss" required>
                                        </div>
                                        @error('date_naiss')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" name="lieu_naiss" class="form-control @error('lieu_naiss') is-invalid @enderror" placeholder="Saisir le lieu de naissance" required>
                                        @error('lieu_naiss')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" name="num_cni" class="form-control @error('num_cni') is-invalid @enderror" placeholder="Saisir le numéro de cni" required>
                                        @error('num_cni')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-lg-4 mb_30">
                                        ...
                                        <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Saisir l'adresse Email">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
