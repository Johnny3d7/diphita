...
@section('subtitle')
    Configuration du montant Traitement et kit d'inscription     
@endsection
                ...
                <div class="white_card card_height_100 mb_30">
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title">
                                <h3 class="m-0">Modifier le montant traitement et kit d'inscription</h3>
                    ...
                    <div class="white_card_body">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.montant-kit.store') }}" method="post">
                                @csrf
                                @method('POST')
                                <div class="form-row">
