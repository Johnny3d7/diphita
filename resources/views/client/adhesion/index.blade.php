                        ...
                        <table class="table display nowrap table-striped table_diphita">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" class="status_btn" style="background-color: orangered">A traiter</a></td>
                                    <td>
                                        <div class="header_more_tool">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('admin.adhesion.valider', ['id' => $adhesion->id]) }}"> <i class="fas fa-edit"></i> Valider</a>
                                                    
                                                  <a class="dropdown-item" href="{{ route('admin.adhesion.rejeter', ['id' => $adhesion->id]) }}"> <i class="ti-trash"></i> Rejeter</a>
                                                </div>
                                              </div>
                                        </div>
                                    </td>
